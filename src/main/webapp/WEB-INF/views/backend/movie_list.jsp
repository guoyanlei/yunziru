...
<head>
    ...
    <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/static/backend/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/static/backend/i/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/backend/css/amazeui.min.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/backend/css/admin.css">
...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <a href="javascript:;" class="tpl-logo">
            <img src="${pageContext.request.contextPath}/static/backend/img/logo.png" alt="">
        </a>
    </div>
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                ...
                <ul class="am-dropdown-content tpl-dropdown-content">
                    ...
                    <li>
                      ...
                      <img src="${pageContext.request.contextPath}/static/backend/img/user02.png" alt=""> </span>
                      ...
                      <span class="tpl-dropdown-content-from"> 禁言小张 </span>
                        ...
                        <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
                      <img src="${pageContext.request.contextPath}/static/backend/img/user03.png" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                    <span class="tpl-header-list-user-nick">禁言小张</span><span class="tpl-header-list-user-ico"> <img src="${pageContext.request.contextPath}/static/backend/img/user01.png"></span>
                </a>
                            ...
                            <div class="tpl-table-images-content">
                                ...
                                <a href="javascript:;" class="tpl-table-images-content-i">
                                    <div class="tpl-table-images-content-i-info">
                                            <span class="ico">
                                    <img src="${pageContext.request.contextPath}/static/backend/img/user02.png" alt="">追逐
                                 </span>

                                    </div>
                                    <span class="tpl-table-images-content-i-shadow"></span>
                                    <img src="${pageContext.request.contextPath}/static/backend/img/a1.png" alt="">
                                </a>
