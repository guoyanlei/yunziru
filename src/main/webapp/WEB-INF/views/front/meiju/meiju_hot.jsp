...
<html lang="zh">
<head>
    <title>云自如-${categoryCH}正在热更美剧 百度云 云资源 百度网盘资源 bt种子分享</title>
...
<div class="banner_navbg">
    <div class="am-g">
        <div class="banner_nav"><span class="am-icon-caret-right">  筛选：</span>
            ...
            <a href="${pageContext.request.contextPath}/meijus/${category}/hot" title="正在热更" target="_self" class="click_rqzg banner_hover" >正在热更</a>
            <a href="${pageContext.request.contextPath}/meijus/${category}/finish" title="已经完结" target="_self"  class="click_rqzg">已经完结</a>
        </div>
    </div>
</div>
...
<script>
    ...
    function load_more(){
        ...
        $.get('hot/list?page='+ page + '&size=' + pageSize,function(data){
            ...
            for( var i = 0 ; i < data.data.length ; i++ ){
                ...
                "                        </div>\n" +
                "                        <div class=\"am-gallery-desc\" style=\"padding-top: 5px;\"> 【" +data.data[i].updateStatus + "】" + data.data[i].title + "</div>\n" +
                "                    </a>\n" +
                "                </div>\n" +
                "            </li>";
            }
